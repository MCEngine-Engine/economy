package io.github.mcengine.spigotmc.economy.engine;
...
/**
 * Main SpigotMC plugin class for the MCEngine Economy module.
 */
public class MCEngineEconomySpigotMC extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        getLogger().info("Project Repository Name: " + getConfig().getString("project.repo.name", "economy"));
        getLogger().info("Project Repository URL: " + getConfig().getString("project.repo.url", "https://github.com/MCEngine-Engine/economy"));
        getLogger().info("Project Repository Issues URL: " + getConfig().getString("project.repo.issue.url", "https://github.com/MCEngine-Engine/economy/issues"));
        getLogger().info("Project Website URL: " + getConfig().getString("project.website.url", "https://mcengine-website.github.io/economy"));
    }
